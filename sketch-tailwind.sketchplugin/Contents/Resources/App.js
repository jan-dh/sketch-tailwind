...
class Colors extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  render() {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Colors are taken from the Layer Styles. When adding additional colors, try to use variable names for the names and hex for the colors.")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
      className: "mb-4"
