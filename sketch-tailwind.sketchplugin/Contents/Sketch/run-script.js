...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/run-script.js");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/bd2f09ef73bc2a65576b4349417f2d80.html").path();
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  const doc = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.fromNative(context.document);
  const options = {
  ...
  const webContents = browserWindow.webContents; // only show the window when the page has loaded
  ...
  webContents.on('did-finish-load', () => {
    ...
    webContents.executeJavaScript(`setInitialState(${JSON.stringify(state)})`).then(res => {
      sketch__WEBPACK_IMPORTED_MODULE_1___default.a.UI.message('State set');
    });
